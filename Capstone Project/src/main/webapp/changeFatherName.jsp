...
<form action="changefathername" method="post" onsubmit="return v()" autocomplete="off">
<tr><td>
...
<tr><td><label>Father Name</label><br>
<input type="text" id="fathername" name="fathername" value="" placeholder="Type Father Name" required onkeyup="fn()"></td></tr>
