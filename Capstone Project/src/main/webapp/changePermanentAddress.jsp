...
<title>Change Permanent Address | XYZ Bank</title>
...
body{
background-image:url('https://wallpaperaccess.com/full/2311989.jpg');
...
<form action="changepermanentaddress" method="post" onsubmit="return v()" autocomplete="off">
<tr><td>
...
<tr><td><label>Permanent Addressr</label><br>
<textarea id="permanentaddress" name="permanentaddress" value="" placeholder="Type Permanent Address" required></textarea></td></tr>
