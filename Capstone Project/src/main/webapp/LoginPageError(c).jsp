...
<tr><td>
<lable><b>Password</b></lable><br><br><input name="password" type="password" placeholder="Type your Password" required><a style="float:right;" href='forget_password'>Forget password</a></td></tr><tr><td style='align:center ;height:80px; text-align:center'>
