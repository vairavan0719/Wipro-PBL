...
<title>Change Present Address | XYZ Bank</title>
...
body{
background-image:url('https://wallpaperaccess.com/full/2142701.jpg');
...
<form action="changepresentaddress" method="post" onsubmit="return v()" autocomplete="off">
<tr><td>
...
<tr><td><label>Present Address</label><br>
<textarea id="presentaddress" name="presentaddress" value="" placeholder="Type Present Address" required></textarea></td></tr>
